...
const TiresPage = ({ searchParams }: { searchParams: { page?: string } }) => {
    ...
    const [filters, setFilters] = useState<{ width: string | null, height: string | null, season: string | null, manufacturer: string | null, radius: string | null, }>({
        width: null,
        height: null,
        season: null,
        manufacturer: null,
    ...
    const fetchTires = async (updatedFilters = filters, page = currentPage) => {
        ...
        if (updatedFilters.radius) {
            query = query.eq('radius', updatedFilters.radius);
        }
    ...
    const handleFilterChange = (newFilters: { width: string | null, height: string | null, season: string | null, manufacturer: string | null,  radius: string | null,}) => {
